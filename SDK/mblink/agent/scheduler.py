...
class StepLR(_scheduler):
  ...
  def __init__(self, init_value, period, decay=0.1, end_value=None, last_epoch=-1, threshold=0, verbose=False):
...
class StepResetLR(_scheduler):
  ...
  def __init__(self, init_value, period, resetPeriod, decay=0.1, end_value=None, last_epoch=-1, verbose=False):
    self.init_value = init_value
    self.period = period
    self.decay = decay
    self.end_value = end_value
