...
"""
import numpy as np
import inverse_kinematics.IK_solver as IK
import inverse_kinematics.geometrics as geo
...
class robotKinematics:
    def __init__(self, L=0.36, W=0.35, coxa=0.022, femur=0.206, tibia=0.206, height=0.15):
        ...
        """in meter """
        # self.L = 0.39 #length of robot joints
        # self.W = 0.284 #width of robot joints
        self.L = L
        self.W = W
