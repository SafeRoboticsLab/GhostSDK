...
def callback_spirit(data):
    ...
    vicon_data = struct.pack(
        "!9f", data.transform.translation.x, data.transform.translation.y,
        data.transform.translation.z - 0.04, data.transform.rotation.x,
        data.transform.rotation.y, data.transform.rotation.z,
        data.transform.rotation.w, goal[0], goal[1])
...
def listener():
    ...
    rospy.Subscriber("/vicon/goal_box/goal_box", TransformStamped,
                     callback_goal)
    rospy.spin()
