...
print("Starting...")
mb = mb80v2.MB80v2(sim=args.sim, verbose=True, log=args.log)#useMocap=args.mocap)

# Set upstream IP address to 192.168.168.5
mb.setRetry('_UPST_ADDRESS', 105)
mb.setRetry('MB_NO_MEM_VECT', 0) # disable the Xavier stopping this message
